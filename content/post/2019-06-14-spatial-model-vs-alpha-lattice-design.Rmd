...
Las correlaciones vendrían dadas por:


```{r, echo=FALSE, warning=FALSE, fig.align='center',fig.width=4,fig.height=3, message=FALSE, fig.cap="Matriz with correlations"}
